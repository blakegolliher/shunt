...
passed on 2026-09-24. H1a (the runtime bundle), H1b (secret generations) and H1c (resource lifetimes, the retained-bundle bound) have landed; the rest of H1 and H2–H5 are pending.
