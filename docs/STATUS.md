...
Current phase: **POC-2 in progress: steps 1–4 done (lift, sigv4, auth, proxy resign branch); steps 5–8 (probe, s3diff signing modes, bench, docs) wait on the VAST rows in docs/CONTEXT.md.** Track: docs/POC.md. Full design: docs/DESIGN.md.
